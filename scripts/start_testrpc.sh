...
# todo: delete testrpc persistent database every time before starting testrpc
...
rm -rf .mytestrpc
mkdir .mytestrpc
testrpc -d -m "rebel year fine public bright armor sugar biology federal morning ozone scene" \
     --db .mytestrpc \
     ...
     --account="0x2a8e0d9fae83481c9982caf462328ea6f0db3150a9c10ac08f782e09d84ff097,1000000000000000000010001471238800000000000" \
